...
$cmdId = aws ssm send-command --region $Region --document-name AWS-RunShellScript --comment "Overlay Menutopic update" --instance-ids $InstanceIds --parameters file://scripts/ssm-overlay-menutopic.json --query 'Command.CommandId' --output text
