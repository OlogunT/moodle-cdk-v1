#!/usr/bin/env pwsh
# Diagnose backup and copy issues on training.tsin.ca

$ErrorActionPreference = "Stop"

Write-Host "=========================================" -ForegroundColor Cyan
Write-Host "Diagnosing Backup/Copy Issues - TRAINING" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Cyan
Write-Host ""

# Get the instance ID for training (TrainingMoodleCdkStack)
...
if (-not $instanceId -or $instanceId -eq "None") {
    Write-Host "[ERROR] Could not find running training instance" -ForegroundColor Red
    exit 1
}
...
# Get the output
Write-Host "=========================================" -ForegroundColor Cyan
Write-Host "DIAGNOSTIC OUTPUT - TRAINING" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "=========================================" -ForegroundColor Cyan
Write-Host "Diagnostic complete for training.tsin.ca" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Cyan
